...
var checkMdFlavour = function( text, filePath) {
    ...
    console.log(`checkMdFlavour l263 arrayOfLines=${arrayOfLines}`);
    let mdFlavourFound = "";
    const regex = /(?<=\:choosePandocMdFlavour\:).*(?=\:)/;
    //arrayOfLines.forEach( line => {
    //for(let element of arrayOfLines) {
    ...
    for(let i=0; i < arrayOfLines.length; i++ ) {
      ...
      if ((Boolean(arrayOfLines[i])) !== null) {
       ...
       //result = arrayOfLines[i].toString().match( /.*/ )
      }
      if ( result ) { break }
       // if (result) {
       //   //console.log(`checkMdFlavour l271 MATCH FOUND //arrayOfLines[i]=${arrayOfLines[i]} `)
       //   console.log(`checkMdFlavour l272 MATCH FOUND result=${result} `)
       //   break
       // }    /// CHECK THIS break Need for loop to include break     //}
    }
    ...
    if (result) {console.log(`checkMdFlavour l276 MATCH FOUND result=${result} `) }
      ...
      if ( mdFlavours.includes(mdFlavourFound.toString()) ) {
        ...
        console.log(`checkMdFlavour l282 MATCH NOT FOUND in mdFlavours`)
