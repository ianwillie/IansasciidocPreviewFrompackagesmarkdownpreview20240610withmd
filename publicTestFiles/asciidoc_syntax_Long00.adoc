...
:sourcedir: /media/AcerWinData/github_from_home/IansasciidocPreviewFrompackagesmarkdownpreview20240610withmd
...
image::{sourcedir}/publicTestFiles/moon600.jpg[block image,800,450]
